...
int main(int argc, char *argv[])
{
   ...
   rc=stomp_connect( &connection, "phoenix-111", 61613, pool);
   ...
   fprintf(stdout, "Sending connect message.");
   {
      ...
      apr_hash_set(frame.headers, "login", APR_HASH_KEY_STRING, "stmishra");
      apr_hash_set(frame.headers, "passcode", APR_HASH_KEY_STRING, "stmishra");
      apr_hash_set(frame.headers, "vhost", APR_HASH_KEY_STRING, "stomp_queue");
